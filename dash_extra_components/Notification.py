...
- key (string; optional)"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, permission=Component.UNDEFINED, title=Component.REQUIRED, lang=Component.UNDEFINED, body=Component.UNDEFINED, badge=Component.UNDEFINED, tag=Component.UNDEFINED, icon=Component.UNDEFINED, image=Component.UNDEFINED, vibrate=Component.UNDEFINED, require_interaction=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, n_closes=Component.UNDEFINED, n_closes_timestamp=Component.UNDEFINED, key=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'permission', 'title', 'lang', 'body', 'badge', 'tag', 'icon', 'image', 'vibrate', 'require_interaction', 'n_clicks', 'n_clicks_timestamp', 'n_closes', 'n_closes_timestamp', 'key']
        self._type = 'Notification'
        self._namespace = 'dash_extra_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'permission', 'title', 'lang', 'body', 'badge', 'tag', 'icon', 'image', 'vibrate', 'require_interaction', 'n_clicks', 'n_clicks_timestamp', 'n_closes', 'n_closes_timestamp', 'key']
